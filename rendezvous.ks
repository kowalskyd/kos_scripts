...
function relativePositionAt {
  parameter aNode, VesselTarget is target.
...
function relativeVelocity {
  parameter VesselTarget is target, etaTime is 0.
  if etaTime = 0 {
...
function correctionApproach {
  parameter oneNode is nextNode, oneTarget is target, deltaChange is 0.05, deltaTime is 0.001.

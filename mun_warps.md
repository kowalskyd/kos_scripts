...
Use the comment sections below each item to note any desired changes, speed factor adjustments, or lead-time margin tweaks.
...
- **Trigger / Conditions**: Active while pitching over in lower atmosphere.
- **Notes / Comments**:
...
- **Lead Time Offset**: Pre-aligns steering vector, then warps to:
  ...
  *(where margin = 20s to 60s depending on vessel mass)*.
- **Notes / Comments**:
  <!-- Add your feedback or comment here -->
...
- **Warp Mode**: `RAILS` (`WARPTO`)
- **Time Factor / Multiplier**: Automatic On-Rails Warp
- **Lead Time Offset**: `warpto(time:seconds + ETA:transition + 120)` (stops 120 seconds after entering Mun's SOI).
- **Notes / Comments**:
  <!-- Add your feedback or comment here -->
...
- **Warp Mode**: `RAILS` (`WARPTO`)
- **Time Factor / Multiplier**: Automatic On-Rails Warp
- **Lead Time Offset**: `warpto(time:seconds + ETA:transition + 30)` (stops 30 seconds after entering Kerbin's SOI).
- **Notes / Comments**:
  <!-- Add your feedback or comment here -->
...
- **Warp Mode**: `RAILS` (`WARPTO`)
- **Time Factor / Multiplier**: Automatic On-Rails Warp
- **Lead Time Offset**: `warpto(time:seconds + ETA:periapsis - 200)` (stops 200 seconds before atmospheric periapsis).
- **Notes / Comments**:
  <!-- Add your feedback or comment here -->
